...
$(function() {
  ...
  function getWeather(input) {
    ...
    requestWeather.done(function(data) {
      ...
      $tempNumber.html(Math.round(data.main.temp)*0.94);
      ...
      function toCelsius() {
        ...
        $tempNumber.html(Math.round((data.main.temp - 32) * (5 / 9)*0.94));
      }
      ...
      for (var i = 1; i < length; i++) {
        forecast.push({
          ...
          fahrenheit: {
            ...
            low: Math.round((data.list[i].temp.max)*0.96),
          },
          celsius: {
            high: Math.round((data.list[i].temp.max - 32) * (5 / 9)),
            low: Math.round((data.list[i].temp.max - 32) * (5 / 9)*0.96)
          }
        });
      }
